 ...
 * };
 * 
 * multi = new HttpServletMultipartRequest(req, Long.MAX_VALUE, HttpServletMultipartRequest.SAVE_TO_TMPDIR,
 *                                         HttpServletMultipartRequest.ABORT_ON_MAX_LENGTH, &quot;UTF-8&quot;, pl);
 * </pre>
 */
public interface ProgressListener {
     ...
     * @param pContentLength The total number of bytes, which are being read. May be -1, if this number is
     *            unknown.
     * @param pItems The number of the field, which is currently being read. (0 = no item so far, 1 = first
     *            item is being read, ...)
     */
